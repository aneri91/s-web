...
<body id="pageTop">
				...
				<div class="collapse navbar-collapse" id="top-menu-collapse">
					...
					<ul id="top-menu" class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="index.jsp">Menu Cards</a>
							<ul>
								<li class="active"><a href="brunchmenu.jsp">View Brunch
										Menu </a></li>
	...
	<div class="container-fluid breadcrumb-container">
		<div class="container">
			<ol class="breadcrumb">
				<li><a href="index.jsp">Home</a></li>
				<li><a href="brunchmenu.jsp">Menu Cards</a></li>
				<li class="active">View Brunch Menu</li>
			</ol>
		</div>
	</div>
	...
	<section class="single-post">
		...
		<div class="container">
			<div class="col-md-8">
				...
				<%
					try {
						String imgName = "D:\\ScrumptiousImages\\brunchmenu.jpg";
