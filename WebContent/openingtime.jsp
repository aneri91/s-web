...
<body id="pageTop">
			...
			<div class="container container-inner">
				...
				<div class="collapse navbar-collapse" id="top-menu-collapse">
					...
					<ul id="top-menu" class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="OpeningHoursController">Opening
								Hours</a></li>
	...
	<div class="container-fluid breadcrumb-container">
		<div class="container">
			<ol class="breadcrumb">
				<li><a href="index.jsp">Home</a></li>
				<li class="active">Contact Scrumptious</li>
			</ol>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<h1 style="color: #8dc63f">
						<span class="light">Opening</span> <span class="extra-bold">Hour</span>
					</h1>
					<ul class="contacts">
						<%
							String monThursFrom = (String) request.getAttribute("monThursFrom");
						%>
						<%
							String monThursTo = (String) request.getAttribute("monThursTo");
						%>
						<%
							String friSatFrom = (String) request.getAttribute("friSatFrom");
						%>
						<%
							String friSatTo = (String) request.getAttribute("friSatTo");
						%>
						<%
							String sunFrom = (String) request.getAttribute("sunFrom");
						%>
						<%
							String sunTo = (String) request.getAttribute("sunTo");
						%>
						<%
						...
						<li><i class="fa fa-clock-o"></i> Monday to Tuesday <span
							class="bold clock">${monThursFrom} am - ${monThursTo} pm</span></li>
						<li><i class="fa fa-clock-o"></i> Friday to Saturday <span
							class="bold clock">${friSatFrom} am - ${friSatTo} pm</span></li>
						<li><i class="fa fa-clock-o"></i> Sunday <span
							class="bold clock">${sunFrom} am - ${sunTo} pm</span></li>
						<%
							} else {
						%>
						<%
							String monThursFrom1 = (String) request.getAttribute("monThursFrom");
						%>
						<%
							String monThursTo1 = (String) request.getAttribute("monThursTo");
						%>
						<%
							String friSatFrom1 = (String) request.getAttribute("friSatFrom");
						%>
						<%
							String friSatTo1 = (String) request.getAttribute("friSatTo");
						%>
						<%
							String sunFrom1 = (String) request.getAttribute("sunFrom");
						%>
						<%
							String sunTo1 = (String) request.getAttribute("sunTo");
						%>
						<li><i class="fa fa-clock-o"></i> Monday to Tuesday <span
							class="bold clock">${monThursFrom1} am - ${monThursTo1} pm</span></li>
						<li><i class="fa fa-clock-o"></i> Friday to Saturday <span
							class="bold clock">${friSatFrom1} am - ${friSatTo1} pm</span></li>
						<li><i class="fa fa-clock-o"></i> Sunday <span
							class="bold clock">${sunFrom1} am - ${sunTo1} pm</span></li>
						<%
							}
						%>
					</ul>
