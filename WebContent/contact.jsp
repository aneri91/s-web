			...
			<div class="container container-inner">
				...
				<div class="collapse navbar-collapse" id="top-menu-collapse">
					...
					<ul id="top-menu" class="nav navbar-nav navbar-left">
						...
						<li class="active"><a href="contact.jsp">Contact
								Scrumptious</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<h1>
						<span class="light">Contact</span> <span class="extra-bold">us</span>
					</h1>
					<%
						if ("Scrumptious Admin will contact you.".equals((String) session.getAttribute("success"))) {
					%>
					<h5>Thank you for reaching out to us..Scrumptious Admin will
						contact you soon !</h5>
					<%
						}
					%>
					<form name="contactForm" action="ContactController" id="cntForm"
						method="get">
						...
						<div class="row">
							<div class="col-xs-12">
								<textarea name="message" id="message"
									class="form-control contact-message" rows="3"
									placeholder="Enter your message here *" required=""></textarea>
							</div>
						</div>

						<div class="message">
							<span class="label label-lg label-success">Scrumptious
								Admin will contact you..</span>
						</div>
						<button type="submit"
							class="btn btn-primary hvr-shutter-out-horizontal btn-send">SEND</button>
					</form>
